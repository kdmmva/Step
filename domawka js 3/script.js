...
receipt.push(new Item("Prod1", 2, 10));
receipt.push(new Item("Prod2", 1, 20));
receipt.push(new Item("Prod3", 3, 15));
...
function addAuditory(name, seats, faculty) {
    var auditorium = new Auditory(name, seats, faculty);
    auditories.push(auditorium);
}
...
function displayAuditoriesByFaculty(faculty) {
    console.log(`All auditoriums for faculty "${faculty}":`);
    auditories.filter(auditorium => auditorium.faculty === faculty)
              .forEach(auditorium => {
...
function displaySuitableAuditories(group) {
    console.log(`All auditoriums for group "${group.name}":`);
    auditories.filter(auditorium => auditorium.seats >= group.students && auditorium.faculty === group.faculty)
              .forEach(auditorium => {
                  console.log(`Name: ${auditorium.name}, Seats: ${auditorium.seats}`);
              });
}
...
function sortAuditoriesBySeats() {
    console.log("Sorting auditoriums by number of seats:");
...
function sortAuditoriesByName() {
    console.log("Sorting auditoriums by name:");
